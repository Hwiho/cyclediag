...
> **갱신:** 2026-08-06 — §0 Full-cell 우선 스택 · §9 코드 반영 상태 · §12 OSS 참고. BOL 하프셀 OCP fixture 추가 (aged 없음).
...
> **상태 갱신 2026-08-06:** §9.1 대부분 + §9.2 중 full-cell 가능 항목(5.5–5.7, 5.9–5.10, 7.1) 코드 반영.
> `*_est_hc_calibrated`는 aged 하프셀 전까지 null. BOL로는 electrode-side **hypothesis** 진단 가능.
...
| H | BOL HC | OCP library · PE/NE peak attribution · electrode-side hypothesis | halfcell/ |
